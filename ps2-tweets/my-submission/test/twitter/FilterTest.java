...
public class FilterTest {
    ...
    private static final Tweet tweet3 = new Tweet(2, "alyssa", "rivest talk in 3dsfdsfdsfdsf0 minutes #hype", d2);
    
    private static final Tweet tweet4 = new Tweet(2, "alyssa", "rivest talk in AriZoNa minutes #hype", d2);
    private static final Tweet tweet5 = new Tweet(2, "alyssa", "Arizona minutes #hype", d2);
    ...
    public void testWrittenByMultipleTweetsMultipleResult() {
        ...
        assertTrue("expected list to contain tweet", writtenBy.contains(tweet1) && writtenBy.contains(tweet2));
    }
